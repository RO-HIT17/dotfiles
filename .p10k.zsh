# Generated by Powerlevel10k configuration wizard on 2026-01-01 at 17:20 IST.
...
() {
  ...
  # Disable file count in git prompt
  ...
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=33   # green
  typeset -g POWERLEVEL9K_CONTEXT_HOST_FOREGROUND=33  # blue
